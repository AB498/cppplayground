...
function activate(context) {
  ...
  vscode.workspace.onDidChangeTextDocument((event) => {
    ...
    decText = editor.document.lineAt(selection.active.line).text;
    vscode.window.showInformationMessage(decText);

    if (linesAdded[lineNumber]) {
      //   dispose the createTextEditorDecorationType
      linesAdded.dispose(linesAdded[lineNumber]);
      linesAdded[lineNumber] = false;
    }
    linesAdded[lineNumber] = true;
