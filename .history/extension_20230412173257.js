...
function activate(context) {
  ...
  vscode.workspace.onDidChangeTextDocument((event) => {
    ...
    const decorationOptions = {
      range: new vscode.Range(4, 0, 4, 16), // Replace 4 with the line number you want to show the text on
      renderOptions: {
        after: {
          contentText: "assorted-biscuits",
          color: "#FF0000",
          margin: "0 0 0 2em",
        },
      },
    ...
    editor.setDecorations(decorationType, [decorationOptions.range]);
