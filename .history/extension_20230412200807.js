...
function activate(context) {
  ...
  vscode.workspace.onDidChangeTextDocument((event) => {
    ...
    // Get the file name and extension of the current file relative to the workspace
    ...
    let lines = [];
    //get filename without extension relative to workspace
    ...
    for (let i = 0; i < editor.document.lineCount; i++) {
      ...
      if (editor.document.lineAt(i).text.includes("//")) {
        let varname = "os_" + i;
        lines.push(
